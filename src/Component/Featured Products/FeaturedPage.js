...
const FeaturedPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.post('https://elitebackend-sage.vercel.app/dynamicfeaturedproducts/setfeaturedproducts', payload, {
            headers: {
            ...
            // console.log(res)
            notify(1, "Featured Product Added Successfully..!")
        }).catch((err) => {
                ...
                <div className="form mt-24">
                    <div className="w-full px-10 overflow-hidden bg-white rounded-lg border-2 shadow-lg dark:bg-gray-800">
                        <div className="px-6 py-4">
                            <p className="mt-1 text-center text-lg text-gray-500 dark:text-gray-400 uppercase font-bold border-b-2 p-y-2 border-indigo-800 w-1/2 m-auto">Add Featured Products</p>
                            ...
                            <form onSubmit={handleSubmit} autoComplete="off">
                                ...
                                <div className="w-full mt-5">
                                    ...
                                    <input type="text" name="name" className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-md dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" />
                                </div>
